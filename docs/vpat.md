...
| --- | --- | --- |
| axe-core, WCAG 2.2 A/AA rule set, in Chromium against the running application | All 11 views, each signed in as the role that sees it | `test/a11y.test.ts`, CI-gated |
